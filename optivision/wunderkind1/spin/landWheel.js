		...
		function pushComment() {
			$('#first-comment').each(function () {
				$('#first-comment').html(
					...
					<div class="photo">
						<img src="img/commit_03.jpg" alt="#" class="photo-people">
					</div>
					<div class="com-txt">
						<b>Анатолий Подопригора</b>
						<br>
						Я заказывал <a href="#history"><b>Crystal Eyes</b></a>,
						но не для себя, а для своей бабушки – у неё вечно с
						давлением проблемы.
						Лечится пятый день, видит намного лучше, в глазах не
						расплывается. Сегодня впервые за 15
						лет весь день проходила без очков! Как же хорошо видеть всё
						нормально!
						<div class="commit__photo_tov">
							<img src="img/photo_tov_1.jpg" alt="#">
						</div>
					</div>
