	...
	if (window.pageYOffset > `${document.getElementById('history').offsetTop + 50}`) {
		...
		function pushComment() {
			$('#first-comment').each(function () {
				$('#first-comment').html(
					`${`
					<li class="comment odd alt thread-odd thread-alt depth-1" id="li-comment-605392" data-author-name="">
					<div id="comment-605392" class="clearfix inside">
						<div class="left-comment">
							<img alt="" src="img/ava_3.jpg" class="avatar avatar-40 photo" height="50" width="50">
						</div>
						<div class="right-comment">
							<div class="name-time">
								<div class="name"><span>Рита Бартовая</span>,</div>
								<div class="time">
						только что
								</div>
							</div>
							...
							<div class="text">
								<p>Семен вообще зайка))) Марине этой надо было просто давно за себя братся.
									Конечно сама виновата, что растолстела. В бешенстве она, ха! Очевидно,
									ему нравятся худые девушки, а она как думала? Пусть ещё спасибо скажет,
									что никто не успел увести такого мужчинку.<br>
								</p>
							</div>
						</div>
					</div>
